project "phys-demo"
   ...
   links {"vec2", "profiling", "vec-ptr", "ini", "runge-kutta", "geometry", "engine", "imgui", "imgui-SFML", "implot", "phys-app", "sfml-primitives", "omp", "sfml-graphics", "sfml-window", "sfml-system", "OpenGL.framework"}

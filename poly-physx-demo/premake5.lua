project "poly-physx-demo"
   ...
   links {"vec-2D", "profile-tools", "ini-parser", "rk-integrator", "shapes-2D", "engine", "imgui", "imgui-SFML", "implot", "phys-app", "sfml-primitives", "sfml-graphics", "sfml-window", "sfml-system", "OpenGL.framework"}

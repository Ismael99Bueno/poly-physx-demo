...
class adder
{
  ...
  private:
    struct add_specs
    {
        ...
        float width = DEFAULT_SIZE, height = DEFAULT_SIZE, ngon_radius = 0.6f * DEFAULT_SIZE,
              circle_radius = 0.6f * DEFAULT_SIZE, sb_stiffness = 250.f, sb_dampening = 1.2f, sb_radius = 1.f;
